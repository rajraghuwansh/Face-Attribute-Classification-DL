Python notebook code for the multilabel classifier CNN which utilizes pre-trained VGG16 model on Python's Keras library to label each face image on CelebA dataset with specific attributes. 
